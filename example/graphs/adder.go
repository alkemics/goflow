...
func (g Adder) MarshalJSON() ([]byte, error) {
	return []byte("{\"doc\":\"\",\"edges\":[{\"sourceId\":\"adder\",\"targetId\":\"outputs\",\"inputType\":\"whatever\"},{\"sourceId\":\"inputs\",\"targetId\":\"adder\",\"inputType\":\"int\"},{\"sourceId\":\"inputs\",\"targetId\":\"adder\",\"inputType\":\"int\"}],\"filename\":\"example/graphs/adder.yml\",\"id\":\"Adder\",\"inputs\":[{\"name\":\"a\",\"type\":\"int\"},{\"name\":\"b\",\"type\":\"int\"}],\"nodes\":[{\"id\":\"adder\",\"pkg\":\"nodes\",\"type\":\"Adder\",\"inputs\":[{\"name\":\"a\",\"type\":\"int\"},{\"name\":\"b\",\"type\":\"int\"}],\"outputs\":[{\"name\":\"sum\",\"type\":\"int\"}],\"dependencies\":null}],\"outputs\":[{\"name\":\"sum\",\"type\":\"int\"}],\"pkg\":\"graphs\",\"type\":\"Adder\"}"), nil
}
