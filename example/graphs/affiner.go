...
func (g Affiner) MarshalJSON() ([]byte, error) {
	return []byte("{\"doc\":\"\",\"edges\":[{\"sourceId\":\"add_b\",\"targetId\":\"outputs\",\"inputType\":\"whatever\"},{\"sourceId\":\"compute_ax\",\"targetId\":\"add_b\",\"inputType\":\"int\"},{\"sourceId\":\"inputs\",\"targetId\":\"add_b\",\"inputType\":\"int\"},{\"sourceId\":\"inputs\",\"targetId\":\"compute_ax\",\"inputType\":\"int\"},{\"sourceId\":\"inputs\",\"targetId\":\"compute_ax\",\"inputType\":\"int\"}],\"filename\":\"example/graphs/affiner.yml\",\"id\":\"Affiner\",\"inputs\":[{\"name\":\"a\",\"type\":\"int\"},{\"name\":\"b\",\"type\":\"int\"},{\"name\":\"x\",\"type\":\"int\"}],\"nodes\":[{\"id\":\"add_b\",\"pkg\":\"graphs\",\"type\":\"Adder\",\"inputs\":[{\"name\":\"a\",\"type\":\"int\"},{\"name\":\"b\",\"type\":\"int\"}],\"outputs\":[{\"name\":\"sum\",\"type\":\"int\"}],\"dependencies\":null},{\"id\":\"compute_ax\",\"pkg\":\"nodes\",\"type\":\"Multiplier\",\"inputs\":[{\"name\":\"a\",\"type\":\"int\"},{\"name\":\"b\",\"type\":\"int\"}],\"outputs\":[{\"name\":\"product\",\"type\":\"int\"}],\"dependencies\":null}],\"outputs\":[{\"name\":\"result\",\"type\":\"int\"}],\"pkg\":\"graphs\",\"type\":\"Affiner\"}"), nil
}
