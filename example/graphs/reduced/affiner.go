...
func (g Affiner) MarshalJSON() ([]byte, error) {
	return []byte("{\"doc\":\"\",\"edges\":[{\"sourceId\":\"add_b\",\"targetId\":\"outputs\",\"inputType\":\"whatever\"},{\"sourceId\":\"compute_ax\",\"targetId\":\"add_b\",\"inputType\":\"int\"},{\"sourceId\":\"inputs\",\"targetId\":\"add_b\",\"inputType\":\"int\"},{\"sourceId\":\"inputs\",\"targetId\":\"compute_ax\",\"inputType\":\"[]int\"},{\"sourceId\":\"inputs\",\"targetId\":\"compute_ax\",\"inputType\":\"[]int\"}],\"filename\":\"example/graphs/reduced/affiner.yml\",\"id\":\"Affiner\",\"inputs\":[{\"name\":\"a\",\"type\":\"int\"},{\"name\":\"b\",\"type\":\"int\"},{\"name\":\"x\",\"type\":\"int\"}],\"nodes\":[{\"id\":\"add_b\",\"pkg\":\"reduced\",\"type\":\"Adder\",\"inputs\":[{\"name\":\"a\",\"type\":\"int\"},{\"name\":\"b\",\"type\":\"int\"}],\"outputs\":[{\"name\":\"sum\",\"type\":\"int\"}],\"dependencies\":[{\"name\":\"debug\",\"type\":\"bool\"}]},{\"id\":\"compute_ax\",\"pkg\":\"nodes\",\"type\":\"IntReducer\",\"inputs\":[{\"name\":\"list\",\"type\":\"[]int\"}],\"outputs\":[{\"name\":\"product\",\"type\":\"int\"}],\"dependencies\":[{\"name\":\"debug\",\"type\":\"bool\"}]}],\"outputs\":[{\"name\":\"result\",\"type\":\"int\"}],\"pkg\":\"reduced\",\"type\":\"Affiner\"}"), nil
}
